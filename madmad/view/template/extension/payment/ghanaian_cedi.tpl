      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-cod" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="ghanaian_cedi_sort_order" value="<?php echo $ghanaian_cedi_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="ghanaian_cedi_status" id="input-status" class="form-control">
                <?php if ($ghanaian_cedi_status) { ?>
          ...
          <div class="tab-content">
            <?php $row = 0; ?>
              ...
              <table id="naria-account" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  <?php foreach ($ghanaian_cedi_attributes as $ghanaian_cedi_attribute) { ?>
                  <tr id="ghanaian_cedi-row<?php echo $row; ?>">
                    <td class="text-left"><input type="text" name="ghanaian_cedi_attributes[<?php echo $row; ?>][text]" value="<?php echo $ghanaian_cedi_attribute['text']; ?>" placeholder="<?php echo $entry_text; ?>" class="form-control" /></td>

                    <td class="text-left" style="width: 30%;"><input type="text" name="ghanaian_cedi_attributes[<?php echo $row; ?>][value]" value="<?php echo $ghanaian_cedi_attribute['value']; ?>" placeholder="<?php echo $entry_value; ?>" class="form-control" /></td>
