          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="config_whatsapp" value="<?php echo $config_whatsapp; ?>" placeholder="<?php echo $entry_whatsapp; ?>" id="input-telephone" class="form-control" />
                  <?php if ($error_telephone) { ?>
                  <div class="text-danger"><?php echo $error_telephone; ?></div>
                  <?php } ?>
                </div>
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-telephone">instagram</label>
                <div class="col-sm-10">
                  <input type="text" name="config_instagram" value="<?php echo $config_instagram; ?>" placeholder="<?php echo $config_instagram; ?>" id="input-instagram" class="form-control" />
            ...
            <div class="tab-pane" id="tab-option">
              ...
              <fieldset>
                <legend><?php echo $text_chat; ?></legend>
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-code"><?php echo $entry_code; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_code" placeholder="<?php echo $entry_code; ?>" rows="10" id="input-code" class="form-control"><?php echo $config_code; ?></textarea>
                </div>
              </div>                
              </fieldset>
