            ...
            <div class="tab-pane active" id="tab-general">
                ...
                <div class="tab-pane">
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-gallery-title">视频链接</label>
                    <div class="col-sm-10">
                      <input type="text" name="out_url" value="<?=empty($out_url) ? '' : $out_url?>" placeholder="" id="input-gallery-title" class="form-control" />
