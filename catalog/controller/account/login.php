	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if (isset($this->request->post['redirect']) && $this->request->post['redirect'] != $this->url->link('account/logout', '', true) && (strpos($this->request->post['redirect'], $this->config->get('config_url')) !== false || strpos($this->request->post['redirect'], $this->config->get('config_ssl')) !== false)) {
				...
				$this->response->redirect($this->url->link('account/inquiry', '', true));
			}
		}
		...
		if ($this->request->server['HTTPS']) {
			$data['action'] =str_replace(HTTPS_SERVER,LOGIN_SERVERS,$data['action']);
		}else{

			$data['action'] =str_replace(HTTP_SERVER,LOGIN_SERVERS,$data['action']);
		}
	   ...
	   $counts=file_get_contents('https://mad.hotbeautyhairmall.com/index.php?route=account/login/getcustomerbytotal'.'&email='.$this->request->post['email']);
		...
		if(!$json){
			...
			if (isset($this->request->post['redirect']) && $this->request->post['redirect'] != $this->url->link('account/logout', '', true) && (strpos($this->request->post['redirect'], $this->config->get('config_url')) !== false || strpos($this->request->post['redirect'], $this->config->get('config_ssl')) !== false)) {
			    ...
			    $json['redirect'] = $this->url->link('account/inquiry', '', true);
			}
		}
 ...
 */
function makeRequest($url, $expire = 0, $extend = array(), $hostIp = '')
{
