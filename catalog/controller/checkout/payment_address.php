...
class ControllerCheckoutPaymentAddress extends Controller {
	public function index() {
		...
		if(isset($this->session->data['same_as_shipping']))
		    $data['same_as_shipping'] = $this->session->data['same_as_shipping'];
	...
	public function save() {
		...
		if(isset($this->request->post['same_as_shipping'])){
		    $this->session->data['same_as_shipping'] = $this->request->post['same_as_shipping'];
		    ...
		    $this->session->data['same_as_shipping'] = 0;
		}
