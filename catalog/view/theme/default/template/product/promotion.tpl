...
<input type="hidden" name="limit" value='<?=$limit;?>' id='limit'/>
      <img class="changeimage img_bnr yd_hide" data-image='<?=HTTPS_SERVERS;?>catalog/view/theme/default/img/jpg/promotion.jpg' data-mimage='<?=HTTPS_SERVERS;?>catalog/view/theme/default/img/jpg/yd_promotion.jpg'  />
