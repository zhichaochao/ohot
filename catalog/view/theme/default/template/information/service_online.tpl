...
<section>
  <div class="container service-container">
    ...
    <div class="sellfrom">
      <p class="teimg"><img alt="service online" src="<?=HTTPS_SERVERS;?>catalog/view/theme/default/images/tzx/service/sell_from3.jpg" width="1022" height="348"></p>
...
need to keep full inventory to hold your customers.And product quality, delivery speed…</p>
    ...
    <div class="sellform_with">
      ...
      <ul class="sellform_ul sellform_ul2 cf">
        <li>
          <p class="p1"><img alt="100% virgin human hair with cuticle intact" src="<?=HTTPS_SERVERS;?>catalog/view/theme/default/images/tzx/service/advantage_1_hov.png" width="91" height="91"></p>
          <p class="p2">100% virgin human hair with cuticle intact</p>
        </li>
        <li>
          <p class="p1"><img alt="Wholesale" src="<?=HTTPS_SERVERS;?>catalog/view/theme/default/images/tzx/service/advantage_5_hov.png" width="91" height="91"></p>
          <p class="p2">Wholesale prices</p>
        </li>
        <li>
          <p class="p1"><img alt="Flexible online ordering and fast shipping" src="<?=HTTPS_SERVERS;?>catalog/view/theme/default/images/tzx/service/advantage_2_hov.png" width="91" height="91"></p>
          <p class="p2">Flexible online ordering and fast shipping </p>
        </li>
        <li>
          <p class="p1"><img alt="7-Day return and exchange guarantee" src="<?=HTTPS_SERVERS;?>catalog/view/theme/default/images/tzx/service/advantage_6_hov.png" width="91" height="91"></p>
          <p class="p2">7-Day return and exchange guarantee</p>
        </li>
          <li>
          <p class="p1"><img alt="Educational" src="<?=HTTPS_SERVERS;?>catalog/view/theme/default/images/tzx/service/advantage_7_hov.png" width="91" height="91"></p>
