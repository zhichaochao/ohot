		...
		<div class=" in_content peo_center">
			...
			<div class="content clearfix">
				...
				<div class="right m_call clearfix">
					<p><img src="<?=HTTPS_SERVERS;?>catalog/view/theme/default/img/png/call1.png" alt="" /> +8613450252494</p>
					<a href="mailto:hellena@hotbeautyhair.com"><p><img src="<?=HTTPS_SERVERS;?>catalog/view/theme/default/img/png/call2.png" alt="" /> rebecca@hotbeautyhair.com</p></a>	
