...
//		print_r($product_option_query->rows );exit();
        ...
        if ($product_option_query->row) {
            foreach ($product_option_query->rows as $product_option) {
				...
				'product_option_value' =>$product_option_value_query->row
			    );
            }
        }
