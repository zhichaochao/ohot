      ...
      <div class="col-md-4">
        <div class="panel panel-default">
          ...
          <table class="table">
            <tbody>
              <tr>
                <td style="width: 1%;"><button data-toggle="tooltip" title="<?php echo $text_order_no; ?>" class="btn btn-info btn-xs"><i class="fa fa-tag fa-fw"></i></button></td>
                <td><?php echo $order_no; ?></td>
              </tr>
			  <tr>
                <td style="width: 1%;"><button data-toggle="tooltip" title="<?php echo $text_transaction_id; ?>" class="btn btn-info btn-xs"><i class="fa fa-tags fa-fw"></i></button></td>
            ...
            <fieldset>
              ...
              <form class="form-horizontal">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <?php if($order_status_id==5){ ?><input name="order_status_id" value="<?php echo $order_status_id; ?>" type="hidden"><?php } ?>
...
$('#button-history').on('click', function() {
	...
	$.ajax({
		...
		//data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&notify=' + ($('input[name=\'notify\']').prop('checked') ? 1 : 0) + '&override=' + ($('input[name=\'override\']').prop('checked') ? 1 : 0) + '&append=' + ($('input[name=\'append\']').prop('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()),
		  data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&notify=' + ($('input[name=\'notify\']').prop('checked') ? 1 : 0) + '&append=' + ($('input[name=\'append\']').prop('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()) + '&shippingNumber=' + encodeURIComponent($('#shippingNumbervalue').val()),
		beforeSend: function() {
