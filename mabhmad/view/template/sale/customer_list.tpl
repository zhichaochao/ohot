            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'c.status') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left" style="color: red;">上月消费</td>
                  <td class="text-left" style="color: red;">客户总消费</td>
                  <td class="text-left" style="color: red;">离下一级还需要消费</td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $customer['lastmonth']; ?>
                  <td class="text-left"><?php echo $customer['hisorder_totals']; ?>&nbsp&nbsp&nbsp&nbsp&nbsp(<?php echo $customer['ordersnum']; ?>&nbsp单)</td>
                  <td class="text-left"><?php echo $customer['nextlevel']; ?>
                  <td class="text-left"><?php echo $customer['date_added']; ?></td>
                  <td class="text-right">
                  <a href="<?php echo $customer['edit']; ?>" data-toggle="tooltip" title="查看详情" class="btn btn-info"><i class="fa fa-eye"></i></a>
