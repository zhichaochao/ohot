          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($gallery['out_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $gallery['out_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $gallery['out_id']; ?>" />
                    <?php } ?>
                  </td>
                  <td class="text-left"><?php echo $gallery['out_url']; ?></td>
