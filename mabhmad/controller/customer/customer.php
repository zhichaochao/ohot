...
class ControllerCustomerCustomer extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$done="addCustomer:name=".$this->request->post['firstname'].' '.$this->request->post['lastname'];
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			//获取编辑中的顾客信息
			$result = $this->model_customer_customer->getCustomer($this->request->get['customer_id']);
			//获取路由参数
			$doneUrl=isset($this->request->get['route']) ? $this->request->get['route'] : "";
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $customer_id) {
				$result['name'][] = $this->model_customer_customer->getCustomer($customer_id);
            ...
            foreach($result['name'] as $value){
            	$name.='ID='.$value['customer_id'].',name='.$value['firstname'].' '.$value['lastname'].';';
            }
