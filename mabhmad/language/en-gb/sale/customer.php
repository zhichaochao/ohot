...
// Text
$_['text_success']          = '成功: 已修改用户信息！';
$_['text_list']             = '客户销售统计列表';
$_['text_add']              = '添加用户';
$_['text_edit']             = '编辑用户';
$_['text_default']          = '默认';
$_['text_balance']          = '账户';
...
// Help
$_['help_safe']             = '选中时，可避免反欺诈系统识别此用户';
$_['help_points']           = '使用用减号（-）减少奖励积分';

// Error
$_['error_warning']         = '警告: 详细检查相关错误！';
$_['error_permission']      = '警告: 无权限修改用户！';
